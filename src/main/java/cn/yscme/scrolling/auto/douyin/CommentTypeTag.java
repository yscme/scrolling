...
/**
 * Protobuf enum {@code cn.yscme.scrolling.auto.douyin.CommentTypeTag}
 */
public enum CommentTypeTag
    ...
    getDescriptor() {
        return cn.yscme.scrolling.auto.douyin.Douyin.getDescriptor().getEnumTypes().get(0);
    }
    ...
    // @@protoc_insertion_point(enum_scope:cn.yscme.scrolling.auto.douyin.CommentTypeTag)
}
